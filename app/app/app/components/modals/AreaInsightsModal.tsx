...
const AreaInsightsModal = ({ handleClose }) => {
  ...
  return (
    <div className="flex bottom-20 w-full absolute h-[14rem] justify-center pl-16 pr-28">
      <div className={`w-full bg-[#2a3042] p-2 rounded-md transition-transform duration-300 ${showModal ? 'animate-fadeInUp' : 'opacity-0'}`}>
        <div className="flex items-center justify-between mb-2">
          <h2 className="text-zinc-300 text-[13px] font-semibold mb-2">Insights da Área</h2>
          <button
            onClick={handleClose}
